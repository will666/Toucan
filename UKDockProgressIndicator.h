...
@property (getter=maxValue,setter=setMaxValue:) double max;
@property (getter=minValue,setter=setMinValue:) double min;
@property (getter=doubleValue,setter=setDoubleValue:) double current;
